...
const Checkout = ({ cart, order, onCaptureCheckout, error }) => {
  ...
  const [shippingData, setShippignData] = useState({})
  ...
  const Confirmation = () => order.customer ? (
    ...
    <>
    <div>
      <Typography variant="h5">There was an issue with you payment method.</Typography>
      <Divider className={classes.divider} />
    </div>
    <br />
    <Button component={Link} to="/" variant="outlined" type="button">Back to shop</Button>
    ...
    <CssBaseline />
      ...
      <main className={classes.layout}>
        <Paper className={classes.paper}>
          ...
          {/* Checkout token is added before the form so that it requires the token to be active before rendering */}
